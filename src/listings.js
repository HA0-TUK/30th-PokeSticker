...
async function initializeListingsPage() {
  ...
  resetListingsButton.textContent = listingStoreMode === "firebase" ? "내 게시글 삭제" : "게시글 비우기";
  listingIntro.textContent =
    listingStoreMode === "firebase"
      ? "현재 교환을 찾고 있는 게시글입니다. 마이페이지 기준으로 교환 가능성이 높은 글부터 정렬됩니다."
      : "게시판에 접근할 수 없습니다.";
